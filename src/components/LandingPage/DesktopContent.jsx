...
export default function DesktopContent() {
        ...
        <div className="flex flex-row gap-8">
          <div>
            ...
            <p className="text-xl">
              ...
              you the skills you need through Hack Sessions every Sunday. At
              each Hack Session you receive a 30-minute workshop, and then 90
  ...
  return (
    <>
      {AboutSection}
      <div className="bg-oasis-light flex flex-col items-center pt-24">
        <h1 className="text-4xl text-oasis-blue mb-8">Session by Session</h1>
